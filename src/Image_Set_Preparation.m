function Image_Set_Preparation(EMG,Subject_number,channels,Movements,Seconds_per_move,Repetitions,Seconds_rest,sample_rate,Feature_group,image_type,Time_window_length,Time_overlap)

threshold=0.000001;                 %Threshold for some features
Low_frequency=20;                   %High pass cutoff frequency
High_frequency=450;                 %Low pass cutoff frequency
    ...
    for k = 1:Movements
       ...
       new_address = [address file_mov '\']
        for j = 1:Windows_per_movement(k)
            ...
            address_image = [new_address 'image' num2str(j) '.png'];
